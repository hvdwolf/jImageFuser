...
public class Utils {
    ...
    static public String returnBasicImageDataString(String filename, String stringType) {
        ...
        if ("html".equals(stringType)) {
            ...
            imginfo.append("<html><b>" + filename + "</b>");
            imginfo.append("<br>" + ResourceBundle.getBundle("translations/program_strings").getString("lp.imagesize") + ": " + imgBasicData.get("ImageWidth") + " x " + imgBasicData.get("ImageHeight"));
